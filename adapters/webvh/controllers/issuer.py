...
class IssuerController:
    ...
    def setup_anoncreds(self):
        ...
        self.cred_def_id = (
            self.create_cred_def(self.schema_id)
            .get("credential_definition_state")
            .get("credential_definition_id")
        )
        self.rev_reg_id = (
            self.get_active_rev_reg(self.cred_def_id).get("result").get("revoc_reg_id")
        )
    ...
    def create_schema(self):
        r = requests.post(
            ...
            json={
                "schema": {
                    "attrNames": [
                        attribute for attribute in Settings.CREDENTIAL.get("preview")
                    ],
        ...
        r = requests.post(
            ...
            json={
                "options": {
                    ...
                    "parameters": {"portable": False, "prerotation": False},
                }
            },
        )
